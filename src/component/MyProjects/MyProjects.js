               ...
               <Col className="d-flex my-5">
                 <Col>
                    <div class="card text-dark" style={{width: "18rem"}}>
                        <img src="https://i.ibb.co/N9F1zLv/v-Fa-X5x-F98q.png" class="card-img-top img-fluid h-75"  alt="..." />
                        <div class="card-body">
                            ...
                            <button className="btn btn-dark rounded-pill">Details</button>
                            </div>
                        </div>
                    </div>
                </Col>
                <Col>
                    <div class="card text-dark" style={{width: "18rem"}}>
                        <img src="https://i.ibb.co/d4x2RfC/5-IC84-Ba-ETz-1-1.png" class="card-img-top img-fluid h-75"  alt="..." />
                        <div class="card-body">
                            <h3>Royal Enfield</h3>
                ...
                <Col>
                    <div class="card text-dark" style={{width: "18rem"}}>
                        <img src="https://i.ibb.co/wchrCrv/Wuo-Q8g-Zunc.png" class="card-img-top img-fluid h-75"  alt="..." />
                        <div class="card-body">
